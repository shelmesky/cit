...
char reservedTable[reservedNum][idLen] =
        {
                ...
                "call", "int", "imul", "idiv", "neg", "inc", "dec", "jmp", "je", "jg", "jl", "jge", "jle", "jne", "jna",
                "push", "pop",//1p
                "ret",//0p
...
static enum symbol reservedSymbol[reservedNum] =
        {
                ...
                i_call, i_int, i_imul, i_idiv, i_neg, i_inc, i_dec, i_jmp, i_je, i_jg, i_jl, i_jge, i_jle, i_jne, i_jna,
                i_push, i_pop,//1p
                i_ret,//0p
