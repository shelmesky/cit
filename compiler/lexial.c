...
static char reservedTable[reservedNum][idLen] = {"break", "char", "continue", "else", "extern", "if", "in", "int",
                                                 "out", "return", "string", "void", "while"};
static enum symbol reservedSymbol[reservedNum] = {rsv_break, rsv_char, rsv_continue, rsv_else, rsv_extern, rsv_if,
                                                  rsv_in, rsv_int, rsv_out, rsv_return, rsv_string, rsv_void,
                                                  rsv_while};
